...
set :repository, 'git@github.com:pfadismn/pfadismn.ch.git'
set :branch, 'master'
set :user, 'rails'
...
set :shared_paths, ['config/database.yml', 'config/email.yml', 'config/application.yml', 'log', 'public/photos', 'var', '.env']
