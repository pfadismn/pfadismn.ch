...
ActiveRecord::Schema.define(version: 2019_01_27_134546) do
  ...
  create_table "meeting_protocols_members", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "member_contacts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "contact_id"
    t.integer "member_id"
    t.string "relation"
  end

  create_table "member_functions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.integer "mask"
  end
  ...
  create_table "organisational_units", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "motto"
    t.string "caption"
